...
public class Main { // Déclaration de la classe principale
    public static void main(String[] args) { // Méthode principale, point d'entrée du programme
        try (Scanner scanner = new Scanner(System.in)) { // Création d'un objet Scanner pour lire l'entrée utilisateur, avec fermeture automatique
            ...
            if (identifiant.equals("Divine") && motDePasse.equals("Divine45")) { // Si les identifiants sont corrects
                ...
                System.out.println("Identifiants incorrects !"); // Message d'erreur
            }
    ...
    public static void afficherMenu(Scanner scanner) {
        ...
        do {
            ...
            switch (choix) {
                case 1 -> GestionEleves.menuEleves(scanner); // Si l'utilisateur choisit 1, appel du menu de gestion des élèves
                case 2 -> GestionProfesseurs.menuProfesseurs(scanner); // Si l'utilisateur choisit 2, appel du menu de gestion des professeurs
                case 3 -> GestionUtilisateurs.menuUtilisateurs(scanner); // Si l'utilisateur choisit 3, appel du menu de gestion des utilisateurs
                case 0 -> System.out.println("Au revoir !"); // Si l'utilisateur choisit 0, affichage du message d'au revoir
